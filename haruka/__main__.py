...
PM_START = """
Hola {}, me llamo {}! Si tienes alguna pregunta sobre como usarme, presiona el boton "Commands".

Soy un bot para administrar grupos mantenido por [esta persona](t.me/CarlosBurelo).
Soy parecida a [Marie](https://github.com/PaulSonOfLars/tgbot) 
Estoy hecha python3, usando la librería de python-telegram-bot, y soy totalmente de codigo abierto. 
puedes ver lo que me hace funcionar [aquí](https://github.com/carlos-burelo/CortanaBot)!
"""
...
def start(bot: Bot, update: Update, args: List[str]):
    ...
    if update.effective_chat.type == "private":
        ...
        update.effective_message.reply_text("Base de datos actualizada")
...
def send_start(bot, update):
    ...
    text = PM_START
    #http://t.me/AssistantCortana_bot?startgroup=true
    keyboard = [[InlineKeyboardButton(text="🇲🇽 Language", callback_data="set_lang_")]]
    keyboard += [[InlineKeyboardButton(text="➕ Add to group", url=f"http://t.me/AssistantCortana_bot?startgroup=true"), 
